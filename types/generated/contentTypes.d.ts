...
export interface ApiStudentClassStudentClass extends Schema.CollectionType {
  ...
  attributes: {
    ...
    faculty_number: Attribute.String;
    faculty_name: Attribute.String;
    subject_code: Attribute.String;
    subject_description: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiStudentGradeStudentGrade extends Schema.CollectionType {
  collectionName: 'student_grades';
  info: {
    singularName: 'student-grade';
    pluralName: 'student-grades';
    displayName: 'student_grade';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    prelim_grade: Attribute.String;
    prelim: Attribute.Float;
